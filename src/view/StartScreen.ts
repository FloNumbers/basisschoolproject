class StartScreen {
    ...
    public drawCompassAndButtonAndTextToCanvas() {
        ...
        this.canvas.writeButtonToCanvas("./assets/images/oldButton.png", this.canvas.getCenter().X - 125, this.canvas.getCenter().Y + 250, "Start", 35, this.canvas.getCenter().X, this.canvas.getCenter().Y + 340, PlayerHandler.getFontColor(), "center", "Old English Text MT");
